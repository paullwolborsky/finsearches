 ...
 * - $above_middle_classes: String of classes that can be used to style the
 * - "Above Middle" region.
 *
 ...
 * - $below_middle_classes: String of classes that can be used to style the
 * - "Below Middle" region.
 *
...
print $layout_attributes; ?> class="<?php print $classes; ?> clearfix">
  ...
  <div class='form form-layout-default clearfix'>
    <div class='column-main'>
      ...
      class="ds-above-middle<?php print $above_middle_classes; ?>">
