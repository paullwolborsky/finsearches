    ...
    Drupal.behaviors.drupalexp_presets = {
        attach: function (context, settings) {
            ...
            $('#edit-drupalexp-presets-list').change(function () {
                ...
                $('#edit-drupalexp-base-color-opposite').val(presets[current_preset].base_color_opposite || presets[current_preset].base_color);
            ...
            setInterval(function(){$('.preset-option').trigger('change')},500);
        }
    };
})(jQuery)
