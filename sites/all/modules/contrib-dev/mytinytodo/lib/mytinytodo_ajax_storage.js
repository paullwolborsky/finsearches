...
mytinytodoStorageAjax.prototype = 
{
	...
	fullNewTask: function(params, callback)
	{
		$.post(base_path + 'mytinytodo/ajax' + add_args + 'fullNewTask',
			...
			contacttypes: JSON.stringify(params.contacttypes),
	...
	setShowCompletedTasks: function(params, callback)
	{
		$.post(base_path + 'mytinytodo/ajax' + add_args + 'setShowCompletedTasks', { list:params.list, compl:params.compl, fid: field_id, csrf: csrf_token }, callback, 'json');
        }
